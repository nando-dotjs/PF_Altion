...
def runSuite1():
    ...
    suite1.login("mati@gmail.com","Matt9412@")
    ...
    suite1.login("Inactivo@gmail.com","Matt9412@")
...
def runSuite2():
    ...
    suite2.Register("Matias","Garcia","matias.garcia1@gmail.com","","Empresa")
    print('Caso de prueba 1 Ejecutado')

    # ingreso con mail erroneo
    suite2.Register("Matias","Garcia","matias.garciagmailcom","Matias1104@","Empresa")
    print('Caso de prueba 2 Ejecutado')

    # ingreso con datos válidos.
    suite2.Register("Matias","Garcia","matias.garcia.leenen@gmail.com","Matias1104@","Empresa")
    print('Caso de prueba 3 Ejecutado')

    # chequear que se creo con con estado activo.
    suite1.login("matias.garcia.leenen@gmail.com","Matias1104@")
