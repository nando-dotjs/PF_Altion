        ...
        <div>
            ...
            <Container>
               ...
               <p> Las cookies son pequeños fragmentos de texto que se utilizan para almacenar información en los navegadores web. Se usan para almacenar y recibir identificadores e información adicional en ordenadores, teléfonos y otros dispositivos. Otras tecnologías, incluidos datos que almacenamos en tu navegador web o tu dispositivo, identificadores asociados a tu dispositivo y otro software, se utilizan con fines similares. A efectos de esta política, todas estas tecnologías reciben el nombre de “cookies”.
                Utilizamos cookies en los siguientes casos: si tienes una cuenta de UPC, si usas los Productos de UPC (incluido nuestro sitio web y nuestras aplicaciones) o si visitas otros sitios web y aplicaciones que utilicen los Productos de UPC.
                ...
                <p>Las cookies nos ayudan a proporcionar, proteger y mejorar los Productos; por ejemplo, nos permiten personalizar el contenido, adaptar los anuncios y medir su rendimiento, y ofrecer una experiencia más segura. Entre las cookies que usamos se incluyen las de sesión, que se eliminan cuando cierras el navegador, y las persistentes, que permanecen en el navegador hasta que caducan o las eliminas. Aunque las cookies que utilizamos pueden cambiar de vez en cuando a medida que mejoramos y actualizamos los Productos de Meta, las utilizamos con los siguientes fines:
                Autenticación
                ...
                la página Web www.unidosporlaclasificación.com</p>
